...
class PostViewModel @Inject constructor(
    ...
    private var currentSizeLastPost by SavableProperty(savedStateHandle, KEY_SIZE_LAST, INIT_POST_LOAD)

    private var enableGetMyPost by SavableProperty(savedStateHandle, KEY_ENABLE_MYSELF, true)
    private var currentSizeMyPost by SavableProperty(savedStateHandle, KEY_SIZE_MYSELF, INIT_POST_LOAD)
